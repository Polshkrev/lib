...
- `entry_make_directory`: To create an entry of type `DIRECTORY_ENTRY_TYPE`.
...
- `entry_remove_file`: To remove an entry of type `FILE_ENTRY_TYPE`.
- `entry_remove_directory`: To create an entry of type `DIRECTORY_ENTRY_TYPE`.
