...
* @param Initial capacity to set for the buffer.
...
/*
* @brief Append a character to the buffer of characters. If the buffer is full, the buffer is resized by an exponential factor of 2.
...
/*
* @brief Resize the buffer by an exponentional factor of 2.
