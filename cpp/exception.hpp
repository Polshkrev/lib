...
class Exception : public std::exception
{
    ...
    protected:
        ...
        */
        void _assign_name(const std::string_view name) noexcept;
        /*
...
* @param message A message string (without newline) to be displayed when the exception is thrown. The parametre is marked with const.
*/
Exception::Exception(const std::string_view message) : __message(message)
{
    _assign_name("Exception");
    _assign_repr();
}
...
* @param name name to assign.
*/
void Exception::_assign_name(const std::string_view name) noexcept
{
